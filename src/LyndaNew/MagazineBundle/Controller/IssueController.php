...
use LyndaNew\MagazineBundle\Entity\Issue;
use LyndaNew\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LyndaNewMagazineBundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("LyndaNewMagazineBundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LyndaNewMagazineBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LyndaNewMagazineBundle:Issue:edit.html.twig")
     */
