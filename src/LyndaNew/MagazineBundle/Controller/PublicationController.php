...
namespace LyndaNew\MagazineBundle\Controller;
...
use LyndaNew\MagazineBundle\Entity\Publication;
use LyndaNew\MagazineBundle\Form\PublicationType;
...
class PublicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LyndaNewMagazineBundle:Publication')->findAll();
     ...
     * @Method("POST")
     * @Template("LyndaNewMagazineBundle:Publication:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LyndaNewMagazineBundle:Publication')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LyndaNewMagazineBundle:Publication:edit.html.twig")
     */
