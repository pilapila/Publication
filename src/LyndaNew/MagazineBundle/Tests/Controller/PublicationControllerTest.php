...
namespace LyndaNew\MagazineBundle\Tests\Controller;
...
class PublicationControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'lyndanew_magazinebundle_publication[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'lyndanew_magazinebundle_publication[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
